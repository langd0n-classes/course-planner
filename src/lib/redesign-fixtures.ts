...
const INSTITUTION_ID = "00000000-0000-0000-0000-000000000003";
const CALENDAR_ID = "00000000-0000-0000-0000-000000000004";
const CALENDAR_VERSION_ID = "00000000-0000-0000-0000-000000000005";

const MEETING_TYPE_ID = "00000000-0000-0000-0000-000000000010";
const MEETING_TYPE_VERSION_ID = "00000000-0000-0000-0000-000000000011";
const COURSEWORK_TYPE_ID = "00000000-0000-0000-0000-000000000012";
const COURSEWORK_TYPE_VERSION_ID = "00000000-0000-0000-0000-000000000013";

const MEETING_ACTIVITY_ID = "00000000-0000-0000-0000-000000000020";
const MEETING_ACTIVITY_VERSION_ID = "00000000-0000-0000-0000-000000000021";
const COURSEWORK_ACTIVITY_ID = "00000000-0000-0000-0000-000000000022";
const COURSEWORK_ACTIVITY_VERSION_ID = "00000000-0000-0000-0000-000000000023";

const TERM_ID = "00000000-0000-0000-0000-000000000030";
const TERM_ACTIVITY_ID = "00000000-0000-0000-0000-000000000031";
const TERM_ACTIVITY_REVISION_ID = "00000000-0000-0000-0000-000000000032";

const MILESTONE_TEMPLATE_ID_1 = "00000000-0000-0000-0000-000000000100";
const MILESTONE_TEMPLATE_ID_2 = "00000000-0000-0000-0000-000000000101";
const MILESTONE_TEMPLATE_ID_3 = "00000000-0000-0000-0000-000000000102";
const MILESTONE_TEMPLATE_ID_4 = "00000000-0000-0000-0000-000000000103";

const TERM_ACTIVITY_MILESTONE_ID = "00000000-0000-0000-0000-000000000104";
const TERM_ACTIVITY_TOPIC_ACTION_ID = "00000000-0000-0000-0000-000000000105";
const TERM_CALENDAR_EXCEPTION_ID = "00000000-0000-0000-0000-000000000106";
const ACADEMIC_CALENDAR_PERIOD_ID = "00000000-0000-0000-0000-000000000107";
const CALENDAR_EVENT_ID = "00000000-0000-0000-0000-000000000108";
...
export function createTermActivityRevisionTopicAction(
  ...
  return {
    ...
    termActivityRevisionId: TERM_ACTIVITY_REVISION_ID,
    topicVersionId: "00000000-0000-0000-0000-000000000050",
    action: "practiced",
    notes: null,
    provenance: null,
    ...overrides,
